...
export const PAGE_NAMES = {
  ...
  ONBOARDING_RELATIONSHIP_STATUS: 'onboarding_relationship_status',
  ONBOARDING_MBTI: 'onboarding_mbti',
  ONBOARDING_PARTNER_MBTI: 'onboarding_partner_mbti',
...
export const BUTTON_NAMES = {
  ...
  BACK_RELATIONSHIP_STATUS: 'back_relationship_status',
  NEXT_RELATIONSHIP_STATUS: 'next_relationship_status',
  BACK_MBTI: 'back_mbti',
  NEXT_MBTI: 'next_mbti',
  BACK_PARTNER_MBTI: 'back_partner_mbti',
  NEXT_PARTNER_MBTI: 'next_partner_mbti',
